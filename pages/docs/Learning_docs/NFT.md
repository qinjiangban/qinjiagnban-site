...
得益于以太坊的这些特性，现在可以通过数字方式拥有独特的物品并为你的物品获得合理价格。 以太坊采用包括[“权益证明”]在内的去中心化共识机制保护资产。 这是一种确定谁可以将交易区块添加到链中的低碳方法，并且被认为比另一种能源密集型共识机制[“工作量证明”]更安全。 非同质化代币一直都和高能耗关联，因为以往使用工作量证明来保护以太坊。 情况已经不再是如此。
...
## 如何能够为数字文件分配所有权
虽然互联网能够使数字文件无限复制，但如果您是只想制作 10 份原始版本的艺术家，或者是想发行限量版专辑的音乐家，这就不那么不理想了。

Ethereum 之所以让数字稀缺性变得可能，是因为数据添加到公共区块链上，就意味着每个人都可以看到谁拥有什么，并且要在易手时验证他们的所有权。

### 虽然数字仍然可以无限复制，但数字文件所有权却不是。这怎么可能？
如果您能忍受一会儿经济学术语，我们有必要简要解释一下引领我们至此的概念。Ethereum 是可替代的——您可以用 1 ETH 交换另一个 ETH，而您所拥有的的东西完全相同。

不可替代意味着它是独一无二的。在 Web3 中，非同质化代币 (NFT) 是可证明的稀缺数字项目，包括数字交易卡、赛事门票、游戏中的物品、数字音乐和艺术。

NFT 并不会让您无法复制这些数字文件（当然，您可以选择“点击右键，另存”所有您想要的文件），但它确实可以让您将数字所有权链接到该数字文件上，从而证明它是一个“真实的”文件，所有内容都存储在Ethereum或其他公共区块链上，并且可以在那上面看到。

### 因此，将 NFT 视为真实性证书：虽然可以无限复制原始作品，但证书让您知道哪个是原作。
NFT 在 2021 年将 Ethereum 带入主流，尤其是那些因破纪录的销售额而引来媒体关注的名人和艺术家，Beeple 在 2021 年以 6930 万美元的价格出售了他的“5000 日”作品，使他跻身于 Koons 和 Hockney 的行列，成为佳士得拍卖行评选的“三位身价最高的在世艺术家”。数百万人使用 MetaMask 在市场上或直接向艺术家购买和出售 NFT。

但 NFT 不仅仅是投机。它们代表了创作者将其艺术变现乃至与粉丝联系的新方式。社交媒体和音乐流媒体平台如何通过引入平台这种新的中间人来改变创作者和粉丝之间的关系，这一点人们已经花了很多笔墨去解释。

<h3>例如，如果您在 2021 年在 Spotify 上发布音乐，并且播放量达到平均水平，那么，您只能赚取大约 636 美元。而 Youtube 为每个频道支付约 2.47 美元，Meta 仅为每名创作者支付微不足道的 0.10 美元。</h3>
另一方面，Web3 在 2021 年为每名创作者支付了约 174,000 美元。虽然 Web3 上的 22,400 位艺术家并非都赚到了这个数字，但它确实表明，NFT 已经成为创作者群体的一个重要产业，其中一次销售收入和二次销售版税收入超过 90 亿美元。对于许多在这些新的数字领域运营的创造者，NFT 代表了第一种真正全职支持他们作品的方式。

日益模糊的“创作者经济”是用来描述互联网空间的术语，意在帮助创作者以新方式赚钱。OnlyFans、Twitch 和其他平台承诺，平台用户可自由地从粉丝处直接赚钱，而不是像社交网络那样依赖广告驱动、基于关注度的盈利模式。然而，与 Web3 网络不同，创作者可能会被网络平台随意踢出，且不能拥有他们分享的内容。

随着 NFT 成为赞助人与艺术家关系的一部分，艺术家还可以直接联系他们最早的支持者——Ethereum地址或 ENS 名称的集合，它们可用于艺术家的邮件列表、入场券和支付系统，无论他们使用什么平台，都可以吸引粉丝。

<h3>与 Web2 社交网络不同，NFT 可以在一种服务上购买，然后在二级市场上售出，或用于其他游戏和应用。</h3> 
换句话说，通过继承 Ethereum 的特性，NFT 表示可移动和互操作的任何东西！